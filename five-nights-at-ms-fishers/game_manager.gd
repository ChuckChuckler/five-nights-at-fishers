...
@onready var rooms = [$"../classroom_a",$"../classroom_b",$"../lobby","",$"../classroom_e"]
@onready var cams = [$"../classroom_a".get_node("SubViewport"), $"../classroom_b".get_node("SubViewport"),$"../lobby".get_node("SubViewport"),"",$"../classroom_e".get_node("SubViewport")]
